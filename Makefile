...
deploy :;
	FOUNDRY_PROFILE=${chain} forge script scripts/Deploy.s.sol:Deploy${chain} --rpc-url ${chain} --ledger --mnemonic-indexes ${MNEMONIC_INDEX} --sender ${LEDGER_SENDER} --slow --broadcast --verify --etherscan-api-key ${ETHERSCAN_API_KEY_MAINNET}
